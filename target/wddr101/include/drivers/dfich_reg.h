...
typedef struct dfich_reg
{
    ...
    volatile uint32_t DDR_DFICH_MISR_0_CFG;
    volatile uint32_t DDR_DFICH_MISR_1_CFG;
    volatile uint32_t DDR_DFICH_MISR_2_CFG;
    volatile uint32_t DDR_DFICH_MISR_STA[12][2];
} dfich_reg_t;
