...
void wddr_clear_fifo_reg_if(wddr_handle_t wddr, wddr_channel_t channel)
{
...
void wddr_set_dram_resetn_pin_reg_if(wddr_handle_t wddr, bool override, bool high)
{
    cmn_rstn_set_pin_reg_if(wddr->cmn.cmn_reg, override, high);
}

void wddr_set_chip_select_reg_if(wddr_handle_t wddr, wddr_channel_t channel, wddr_rank_t rank, bool override)
{
...
void wddr_read_bscan_result_reg_if(wddr_handle_t wddr, wddr_dq_byte_t dq_byte, wddr_channel_t channel, uint8_t *result)
{
    // Read BSCAN
