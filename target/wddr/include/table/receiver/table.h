...
{
    const uint8_t                     feedback_resistor;
    const receiver_mode_t             mode;
    const receiver_path_state_t       path_state;
 ...
 *
 * code    Receiver calibration codes.
 */
typedef struct receiver_common_cfg_t
{
    uint8_t     code[REC_PN_SIDE_NUM][REC_TC_SIDE_NUM];
} receiver_common_cfg_t;
