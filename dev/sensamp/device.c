...
/**
 * @brief   Sense Amp (Sensamp) DQ Byte Calibration Internal
 *
 * @details Calibrates all Sensamp Devices in a DQ Byte.
 *
 ...
 */
static wddr_return_t sensamp_dqbyte_cal_internal(sensamp_dqbyte_dev_t *sa_dqbyte,
                                 ...
                                 sensamp_dqbyte_common_cal_t *cal)
{
    ...
    PROPAGATE_ERROR(sensamp_dqbyte_cal_internal(sa_dqbyte, cal->dq));
                                                 ...
                                                 sensamp_dqbit_cal_t data[WDDR_PHY_RANK][WDDR_PHY_DQ_SLICE_NUM])
{
    ...
    for (bit_index = 0; bit_index < WDDR_PHY_DQ_SLICE_NUM; bit_index++)
    {
        ...
        for (sa_index = SA_0_INDEX; sa_index < WDDR_PHY_CFG; sa_index++)
        {
            ...
            // save code into calibration table and apply to regs
            // same for RANK 0 and RANK 1
