 ...
 *
 * @param[in]   dq_reg      pointer to dq path structure to prepare.
 ...
 *
 * @param[in]   ca_reg      pointer to ca path structure to prepare.
 * @param[in]   msr         Mode Set Register value to prepare.
 ...
 *
 * @param[in]   ca_reg     pointer to ca path to prepare.
 ...
 *
 * @param[in]   dq_reg      pointer to dq tx path to prepare.
 * @param[in]   cfg         pointer to configuration structure for dq path.
 *
 * @return      void
 */
 ...
 *
 * @param[in]   dq_reg      pointer to ca path structure to prepare.
 * @param[in]   msr         Mode Set Register value to prepare.
 * @param[in]   cfg         pointer to the frequency configuration parameters
 *                          for the dq block.
 * @return      void
 ...
 *
 * @param[in]   cmn_path    pointer to common device.
 * @param[in]   msr         Mode Set Register value to prepare.
 * @param[in]   cfg         pointer to the frequency configuration parameters
