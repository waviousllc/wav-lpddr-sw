 ...
 * @retval      WAV_LPDDR_SUCCESS if device was enabled.
 * @retval      WAV_LPDDR_ERROR otherwise.
 */
wlpddr_return_t ibias_enable(ibias_dev_t *ibias);
 ...
 * @retval      WAV_LPDDR_SUCCESS if device was disabled.
 * @retval      WAV_LPDDR_ERROR otherwise.
 */
wlpddr_return_t ibias_disable(ibias_dev_t *ibias);
