 ...
 */
#ifndef _LPDE_REG_IF_H_
#define _LPDE_REG_IF_H_
 ...
 */
wlpddr_return_t lpde_set_state_reg_if(lpde_dev_t *lpde, lpde_state_t state);
 ...
 * @return      void
 */
void lpde_set_reg_if(lpde_dev_t *lpde, uint8_t gear, uint8_t delay);

#endif /* _LPDE_REG_IF_H_ */
