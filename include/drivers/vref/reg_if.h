 ...
 */
#ifndef _VREF_REG_IF_H_
#define _VREF_REG_IF_H_
 ...
 *
 * @details Sets the state of the Voltage Reference deivice via CSR.
 *
 * @param[in]   vref    pointer to Voltage Reference device.
 ...
 */
wlpddr_return_t vref_set_state_reg_if(vref_dev_t *vref, vref_state_t state);
