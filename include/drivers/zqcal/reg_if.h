 ...
 */
#ifndef _ZQCAL_REG_IF_H_
#define _ZQCAL_REG_IF_H_

#include <zqcal/zqcal.h>
 ...
 * @return      void
 */
void zqcal_init_reg_if(zqcal_dev_t *zqcal, info_t *p_info);
 ...
 */
wlpddr_return_t zqcal_set_state_reg_if(zqcal_dev_t *zqcal, zqcal_state_t state);
 ...
 * @retval      WAV_LPDDR_SUCCESS if mode was set.
 * @retval      WAV_LPDDR_ERROR otherwise.
 */
wlpddr_return_t zqcal_set_mode_reg_if(zqcal_dev_t *zqcal, zqcal_mode_t mode);
 ...
 * @retval      WAV_LPDDR_SUCCESS if valid mode given and code is set.
 * @retval      WAV_LPDDR_ERROR otherwise.
 */
wlpddr_return_t zqcal_set_code_reg_if(zqcal_dev_t *zqcal, zqcal_mode_t mode, uint8_t code);
 ...
 * @retval      WAV_LPDDR_SUCCESS if voh was set.
 * @retval      WAV_LPDDR_ERROR otherwise.
 */
wlpddr_return_t zqcal_set_voh_reg_if(zqcal_dev_t *zqcal, zqcal_voh_t voh);
