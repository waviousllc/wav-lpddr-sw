 ...
 * @return      void
 */
void wddr_set_dram_resetn_pin_reg_if(wddr_handle_t wddr,
                                     bool override,
                                     bool high);
 ...
 * @return      void
 */
void wddr_set_chip_select_reg_if(wddr_handle_t wddr,
 ...
 * @return      void
 */
void wddr_read_bscan_result_reg_if(wddr_handle_t wddr,
