...
### Drivers (drivers)
Drivers are the layer that interacts directly with the Wavious LPDDR4 hardware.
...
### Applications (app)
Applications are complete programs that are meant to run on LPDDR4 hardware.
